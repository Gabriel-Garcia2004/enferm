    ...
    "minify.css.groups": {
        "5db08": {
            "default": {
                "include": {
                    "files": [
                        "https:\/\/renato.enf.br\/wp-content\/themes\/tortuga\/style.css?ver=2.3.4",
                        "https:\/\/renato.enf.br\/wp-includes\/css\/dist\/block-library\/style.min.css?ver=5.8.2"
                    ]
                }
            }
        }
    ...
    "minify.js.groups": {
        "5db08": {
            "default": {
                "include": {
                    "files": [
                        "https:\/\/renato.enf.br\/wp-includes\/js\/jquery\/jquery.min.js?ver=3.6.0",
                        "https:\/\/renato.enf.br\/wp-includes\/js\/jquery\/jquery-migrate.min.js?ver=3.3.2:2:1"
                    ]
                }
            }
        }
